...
$featured= (bool)het_tstm_get_meta($id,'het_tstm_featured', false);
?>
<article class="het-tstm-item<?php echo $featured ? ' is-featured':''; ?>">
    ...
    <div class="het-tstm-meta">
      ...
      <?php if ($role || $company): ?>
        <div class="het-tstm-role">
          <?php echo esc_html(trim($role.' '.($company?'• '.$company:''))); ?>
        </div>
      <?php endif; ?>
      <?php if ($rating>0): ?>
